...
class VehicleMasterList(models.Model):
	...
	Last_name_assignee = models.CharField(max_length=100, null=True)
	First_name_assignee = models.CharField(max_length=100, null=True)
	...
	Sold_vehicle = models.CharField(max_length=50, null=True)

	def __str__(self):
		return self.Activity_id

	def get_absolute_url(self):
		return reverse('vehicle-list', kwargs={'pk':self.pk})
