...
class reportform(forms.ModelForm):
    ...
    class Meta:
        ...
        widgets= {
            ...
            'a_employee_fname': forms.TextInput(attrs={'class':'form-control'}),
            'a_employee_lname': forms.TextInput(attrs={'class':'form-control'}),
            'a_employee_no': forms.TextInput(attrs={'class':'form-control'}),
            'a_employee_company': forms.TextInput(attrs={'class':'form-control'}),
            'a_employee_group': forms.TextInput(attrs={'class':'form-control'}),
            'a_employee_division': forms.TextInput(attrs={'class':'form-control'}),
            'a_employee_dept': forms.TextInput(attrs={'class':'form-control'}),
