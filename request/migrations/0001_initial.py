    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('plate_no', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='masterlist.VehicleMasterList')),
                ('req_employee_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='masterlist.EmployeeMasterlist')),
            ],
        ),
        migrations.CreateModel(
