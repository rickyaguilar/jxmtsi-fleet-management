...
class CarRentalRequest(models.Model):
	...
	Assignee_Cost = models.FloatField(null=True, blank=True)
	...
	Cost_center = models.FloatField(null=True, blank=True)
	Rental_period = models.FloatField(null=True, blank=True)
...
class Gas_card(models.Model):
	...
	req_employee = models.ForeignKey('masterlist.EmployeeMasterlist', on_delete=models.CASCADE, blank=True)
	...
	plate_no = models.ForeignKey('masterlist.VehicleMasterList', on_delete=models.CASCADE, blank=True)
	...
	date_summitted =models.DateField(auto_now=False, null=True, blank=True)
	fleet_received = models.DateField(auto_now=False, null=True, blank=True)
	fleet_card_no = models.CharField(max_length=100, null=True, blank=True)
	fleet_date_release = models.DateField(auto_now=False, null=True, blank=True)
...
class service_vehicle(models.Model):
	...
	Activity_id = models.CharField(max_length=100,null=True, default=increment_Activity_id)
	request_date = models.DateField(auto_now=False, null=True, blank=True)
	...
	approved_date = models.DateField(auto_now=False, null=True, blank=True)
...
class Vehicle_Repair(models.Model):
	...
	# employee = models.ForeignKey('masterlist.EmployeeMasterlist', on_delete=models.DO_NOTHING)
