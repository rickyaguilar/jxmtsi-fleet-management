...
class voucherform(forms.ModelForm):
    ...
    class Meta:
        ...
        widgets= {
            ...
            'employee_id': forms.Select(attrs={'class':'form-control','id':'emp_id'}),
            'employee_fname': forms.TextInput(attrs={'class':'form-control','id':'emp_fname'}),
            'employee_lname': forms.TextInput(attrs={'class':'form-control','id':'emp_lname'}),
            'employee_group': forms.TextInput(attrs={'class':'form-control'}),
            'employee_cost': forms.TextInput(attrs={'class':'form-control'}),
            ...
            'plate_number': forms.Select(attrs={'class':'form-control'}),
            'odometer_start': forms.TextInput(attrs={'class':'form-control'}),
            'odometer_end': forms.TextInput(attrs={'class':'form-control'}),
            'v_brand': forms.Select(attrs={'class':'form-control','choices':'brand'}),
            'v_make': forms.TextInput(attrs={'class':'form-control'}),
            'v_fuel_type': forms.TextInput(attrs={'class':'form-control'}),
