    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Payee', models.CharField(choices=[('1', 'Globe'), ('2', 'Innove'), ('3', 'Bayan')], max_length=1, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('Activity_id', models.CharField(default=payment.models.increment_Activity_id, max_length=20, null=True)),
                ('PO_no', models.CharField(default=payment.models.increment_PO_no, max_length=100, null=True)),
                ('A_employee_ID', models.CharField(max_length=100, null=True)),
                ('E_First_name', models.CharField(max_length=50, null=True)),
                ('E_Last_name', models.CharField(max_length=50, null=True)),
                ('V_deliverDate', models.DateField(null=True)),
                ('V_plateNo', models.CharField(max_length=20, null=True)),
                ('V_model', models.CharField(max_length=100, null=True)),
                ('V_brand', models.CharField(max_length=100, null=True)),
                ('V_make', models.CharField(max_length=100, null=True)),
                ('V_dealer', models.CharField(max_length=100, null=True)),
                ('LTO_documents', models.DateField(null=True)),
                ('Docs_plate_no', models.CharField(max_length=50, null=True)),
                ('LTO_stickers', models.CharField(max_length=100, null=True)),
                ('Sticker_fields', models.CharField(max_length=100, null=True)),
                ('Date_initial', models.DateField(null=True)),
                ('First_payment', models.CharField(max_length=100, null=True)),
                ('LTO_charges', models.CharField(max_length=100, null=True)),
                ('Outstanding_balance', models.CharField(max_length=100, null=True)),
                ('Date_final', models.DateField(null=True)),
                ('Routing_remarks', models.CharField(max_length=100, null=True)),
                ('V_SLA', models.CharField(max_length=10, null=True)),
                ('Next_process', models.CharField(max_length=100, null=True)),
